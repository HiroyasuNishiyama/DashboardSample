...
module.exports = function(RED) {
    let base = RED.settings.userDir;
    let ui = require(base+'/node_modules/node-red-dashboard/ui')(RED);

    function WsampleNode(config) {
    ...
    RED.nodes.registerType("ui_wsample", WsampleNode);
};
